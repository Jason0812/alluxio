...
public class ListStatusTOptions implements org.apache.thrift.TBase<ListStatusTOptions, ListStatusTOptions._Fields>, java.io.Serializable, Cloneable, Comparable<ListStatusTOptions> {
  ...
  private static final org.apache.thrift.protocol.TField LOAD_FROM_UFS_FIELD_DESC = new org.apache.thrift.protocol.TField("loadFromUfs", org.apache.thrift.protocol.TType.BOOL, (short)3);
  ...
  public boolean loadFromUfs; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    LOAD_FROM_UFS((short)3, "loadFromUfs");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // LOAD_FROM_UFS
          return LOAD_FROM_UFS;
        default:
          return null;
      }
    }
  ...
  private static final int __LOADFROMUFS_ISSET_ID = 1;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.LOAD_DIRECT_CHILDREN,_Fields.LOAD_METADATA_TYPE,_Fields.LOAD_FROM_UFS};
  ...
  static {
    ...
    tmpMap.put(_Fields.LOAD_FROM_UFS, new org.apache.thrift.meta_data.FieldMetaData("loadFromUfs", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
  ...
  public ListStatusTOptions(ListStatusTOptions other) {
    ...
    this.loadFromUfs = other.loadFromUfs;
  }
  ...
  public void clear() {
    ...
    setLoadFromUfsIsSet(false);
    this.loadFromUfs = false;
  }
  ...
  public boolean isLoadFromUfs() {
    return this.loadFromUfs;
  }

  public ListStatusTOptions setLoadFromUfs(boolean loadFromUfs) {
    this.loadFromUfs = loadFromUfs;
    setLoadFromUfsIsSet(true);
    return this;
  }

  public void unsetLoadFromUfs() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __LOADFROMUFS_ISSET_ID);
  }

  /** Returns true if field loadFromUfs is set (has been assigned a value) and false otherwise */
  public boolean isSetLoadFromUfs() {
    return EncodingUtils.testBit(__isset_bitfield, __LOADFROMUFS_ISSET_ID);
  }

  public void setLoadFromUfsIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __LOADFROMUFS_ISSET_ID, value);
  }
  ...
  public boolean equals(ListStatusTOptions that) {
    ...
    boolean this_present_loadFromUfs = true && this.isSetLoadFromUfs();
    boolean that_present_loadFromUfs = true && that.isSetLoadFromUfs();
    if (this_present_loadFromUfs || that_present_loadFromUfs) {
      if (!(this_present_loadFromUfs && that_present_loadFromUfs))
        return false;
      if (this.loadFromUfs != that.loadFromUfs)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_loadFromUfs = true && (isSetLoadFromUfs());
    list.add(present_loadFromUfs);
    if (present_loadFromUfs)
      list.add(loadFromUfs);
  ...
  public int compareTo(ListStatusTOptions other) {
    ...
    lastComparison = Boolean.valueOf(isSetLoadFromUfs()).compareTo(other.isSetLoadFromUfs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLoadFromUfs()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.loadFromUfs, other.loadFromUfs);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetLoadFromUfs()) {
      if (!first) sb.append(", ");
      sb.append("loadFromUfs:");
      sb.append(this.loadFromUfs);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class ListStatusTOptionsStandardScheme extends StandardScheme<ListStatusTOptions> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ListStatusTOptions struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // LOAD_FROM_UFS
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.loadFromUfs = iprot.readBool();
              struct.setLoadFromUfsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ListStatusTOptions struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetLoadFromUfs()) {
        oprot.writeFieldBegin(LOAD_FROM_UFS_FIELD_DESC);
        oprot.writeBool(struct.loadFromUfs);
        oprot.writeFieldEnd();
      }
